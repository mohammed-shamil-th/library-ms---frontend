...
export const booksAPI = {
  ...
  // searchBooks is deprecated - use getBooks with search parameter instead
...
export const dashboardAPI = {
  ...
  getActiveMembersCount: async () => {
    const response = await api.get('/dashboard/active-members-count');
    return response.data;
  },
};
